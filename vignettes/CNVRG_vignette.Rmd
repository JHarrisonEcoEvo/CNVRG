...
We provide limited plotting functions for posteriors as we suspect users will have formatting desires that preclude the use of canned functions. However, a simple way to plot posteriors is via density plots using base 'R'. For example: 
```{r}
